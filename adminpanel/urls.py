...
urlpatterns = [
    ...
    path("doctors/<int:doctor_id>/delete/", views.admin_doctor_delete, name="admin_doctor_delete"),
    path("patients/", views.patients_list, name="admin_patients_list"),
    path("patients/create/", views.admin_patient_create, name="admin_patient_create"),
    ...
    path("staff/create/", views.admin_staff_create, name="admin_staff_create"),
    path("staff/<int:pk>/update/", views.admin_staff_update, name="admin_staff_update"),
    path("staff/<int:pk>/delete/", views.admin_staff_delete, name="admin_staff_delete"),
